...
if (isset($_GET['cate_id'])) {
    ...
    $imgname = null;
    foreach (selectDb("SELECT * FROM categories WHERE cate_id = '$cate_id'") as $cate) {
        $name = $cate['name'];
        $image = $cate['image'];
    }
    if (isset($_POST['btnSua'])) {
        ...
        action("UPDATE categories SET name='$name_new',image = '$img_name_new' WHERE cate_id = '$cate_id'");
    ...
    <div class="container mx-auto">
        <div class="grid grid-cols-12 gap-5">
            ...
            <div class="col-span-10 ">
                ...
                <section class="p-2">
                    <h2 class="text-2xl font-bold pb-5 pt-2">Sửa danh mục</h2>
                        ...
                        <div class="">
                            <div class="py-5">
                                ...
                                <input type="text" name="name" id=""
                                    ...
                                    placeholder="Tên sản phẩm" value="<?= $cate['name'] ?>">
                            </div>
                            <img src="../upload/<?= $cate['image'] ?>" alt="" width="200">
                            <div class="py-5">
                                <label for="" class="text-xl pb-2 font-bold">Ảnh</label>
                                <input type="file" name="image" id="" placeholder="Chọn file"
                                    class="border border-solid border-black rounded-md w-full p-2" value=""
